...
<?php while ( have_rows('parts_set') ) : the_row(); //値のループ ?>
  ...
  <?php if(get_row_layout() == 'm_ttl_set') : ?><h2 class="style_ttl style_ttl_pin"><?php the_sub_field('m_ttl'); //中見出し（h2） ?></h2>
  <?php elseif(get_row_layout() == 's_ttl_set') : ?><h3 class="style_ttl style_ttl_pin"><?php the_sub_field('s_ttl'); //小見出し（h3） ?></h3>
  <?php elseif(get_row_layout() == 'ss_ttl_set') : ?><h4 class="style_ttl style_ttl_pin"><?php the_sub_field('ss_ttl'); //極小見出し（h4） ?></h4>
      ...
      <div class="row<?php if(get_sub_field('acf_container_reverse') == 'true'): ?> reverse<?php else: ?><?php endif; ?><?php if(get_sub_field('acf_container_sp_col') == 'col2'): ?> sp_image_cols sp_col2<?php elseif(get_sub_field('acf_container_sp_col') == 'col3'): ?> sp_image_cols sp_col3<?php endif; ?>">
        ...
        <?php if( have_rows('acf_container_parts') ): ?>
          <?php while ( have_rows('acf_container_parts') ) : the_row(); ?>
            <?php if(get_row_layout() == 'acf_container_h2_set') : ?><h2 class="style_ttl"><?php the_sub_field('acf_container_h2'); //中見出し（h2） ?></h2>
            <?php elseif(get_row_layout() == 'acf_container_h3_set') : ?><h3 class="style_ttl"><?php the_sub_field('acf_container_h3'); //小見出し（h3） ?></h3>
            <?php elseif(get_row_layout() == 'acf_container_h4_set') : ?><h4 class="style_ttl"><?php the_sub_field('acf_container_h4'); //極小見出し（h4） ?></h4>
            ...
            <?php elseif(get_row_layout() == 'acf_container_img_set'): //画像 ?>
              <figure class="<?php if(get_sub_field('acf_container_img_position') == 'left'): ?>text_left<?php elseif(get_sub_field('acf_container_img_position') == 'center'): ?>text_center<?php else: ?>text_right<?php endif; ?>">
            ...
            <?php elseif(get_row_layout() == 'acf_container_btn_set'): //ボタン ?>
              ...
              <?php endif; ?>
              <p class="parts_btn_type_a<?php if(get_sub_field('acf_container_btn_position') == 'left'): ?> text_left<?php elseif(get_sub_field('acf_container_btn_position') == 'center'): ?> text_center<?php else: ?> text_right<?php endif; ?>"><a href="<?php echo esc_url($link_url); ?>" target="<?php echo esc_attr($link_target); ?>"><?php echo esc_html($link_title); ?></a></p>
  ...
  <?php elseif(get_row_layout() == 'img_set'): //画像 ?>
    <?php if ( wp_is_mobile() ) : ?>
      <?php if(get_sub_field('img_pc_or_sp') == 'sp'): //画像：スマホ ?>
        <p class="custom_img custom_img_pin <?php if(get_sub_field('img_position') == 'left'): ?>text_left<?php elseif(get_sub_field('img_position') == 'center'): ?>text_center<?php elseif(get_sub_field('img_position') == 'right'): ?>text_right<?php endif; ?>">
  ...
  <?php elseif(get_row_layout() == 'parts_btn'): //ボタン ?>
    ...
    <?php elseif(get_row_layout() == 'txt_img_set') : //本文＋画像 ?>
      <div class="<?php if(get_sub_field('txt_img_percent') == '1_9'): ?>float-1-9<?php elseif(get_sub_field('txt_img_percent') == '2_8'): ?>float-2-8<?php elseif(get_sub_field('txt_img_percent') == '4_6'): ?>float-4-6<?php elseif(get_sub_field('txt_img_percent') == '5_5'): ?>float-5-5<?php elseif(get_sub_field('txt_img_percent') == '6_4'): ?>float-6-4<?php elseif(get_sub_field('txt_img_percent') == '7_3'): ?>float-7-3<?php elseif(get_sub_field('txt_img_percent') == '8_2'): ?>float-8-2<?php elseif(get_sub_field('txt_img_percent') == '9_1'): ?>float-9-1<?php else: ?>float-3-7<?php endif; ?>">
